...
const EditResume = () => {
  ...
  // THIS FUNCTION WILL HELP IN UPDATING THE RESUMES.. AND PUT WILL HELP IN UPDATION OF BACKEND..
  ...
  const downloadPDF = async () => {
    ...
    // TYPE OF HOW WILL LOOK WHEN DOWNLOADED..
    try {
      await html2pdf()
        .set({
          margin: 0,
        ...
        .from(element)
        .save(); // WE SAVE RESUME HERE AND THEN DOWNLOAD IT..
    ...
    <DashboardLayout>
      ...
      <Modal isOpen={openThemeSelector} onClose={() => setOpenThemeSelector(false)}
        ...
        <div className={containerStyles.modalContent}>
          <ThemeSelector selectedTheme={resumeData?.template.theme} setSelectedTheme={updateTheme}
